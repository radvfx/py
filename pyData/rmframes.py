...
## Python script for removing (rm) a sequence of files
...
argc = len(sys.argv)
if not 1 <=  argc > 2:
    print "\n USAGE: rmframes basename fs (fe (fi (ext)))"
...
if argc  < 4:
    print ''
    print "RMFRAMES takes at least 3 arguments to run the script. Try again, please.\n"
    sys.exit(0)

if argc > 7:
    print ''
    print "RMFRAMES take at most 6 arguments to run the script. Try again, please.\n"
    sys.exit(0)
