#!/usr/bin/python
# turn OFF ALL the AOVs,except primary
...
def aovsOFF():
	...
	mc.setAttr( 'fb_setup1.pass[2].name', "diffuse", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[2].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[3].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[4].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[5].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[6].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[8].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[9].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[11].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[14].type', "n", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[15].type', "n", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[16].type', "n", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[17].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[18].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[19].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[20].enable', 0 )

	## standards end here
	## optional start below
        ...
        mc.setAttr( 'fb_setup1.pass[22].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[23].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[24].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[25].enable', 0 )
        ...
        mc.setAttr( 'fb_setup1.pass[26].enable', 0 )
	...
	mc.setAttr( 'fb_setup1.pass[27].name', "softHalfFaceMatte", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[27].enable', 0 )
	...
	mc.setAttr( 'fb_setup1.pass[28].name', "softBrowMatte", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[28].enable', 0 )
	...
	mc.setAttr( 'fb_setup1.pass[29].name', "softTopHeadMatte", type="string" )
        ...
        mc.setAttr( 'fb_setup1.pass[29].enable', 0 )
...
def closeWindow():
        global aovOFFWindow
        mc.deleteUI( aovOFFWindow, window=True );
        mc.headsUpMessage( 'all Honda AOVs are OFF.', verticalOffset = 50 );

## Make a new window
aovOFFWindow = mc.window( title="aovOffWindow", widthHeight=(400,260), sizeable=False );

## Create a layout for the window appearance
mc.columnLayout( adjustableColumn=True );
mc.button( label='Turn AOVs OFF', command='aovsOFF()', width=396 )
mc.setParent( '..' );

## Resize and display the window
mc.window( aovOFFWindow, edit=True, widthHeight=(512,260));
mc.showWindow( aovOFFWindow );
